...
class Network(object):
    ...
    def construct_model(self, data, hyperparams, keep_prob):
        ...
        self.Wconv1 = self.weight_variable(shape=[hyperparams["filter_row"], hyperparams["filter_column"], 3, hyperparams["n_filter"]], name="kernel")
        self.bconv1 = self.bias_variable(shape=[hyperparams["n_filter"]], name="b_conv")
